		...
		System.out.println("\n\n\t\t\tWelcome to Student Database");
            try (Scanner sc = new Scanner(System.in)) {
                ...
                while(choice != 7){
                    ...
                    String studNum, fName, lName, curse, crushName, courseCode, courseDescript;
                    int yrLevel;
                    char midIn;
                    ...
                    switch(choice){
                        ...
                        case 1:
                            ...
                            if(!database.studEnrolled(list, studNum)){
                                ...
                                System.out.println();
                                courseDescript = sc.nextLine();
                                System.out.println();
                                
                                Course faveSubj = new Course(courseCode, courseDescript);
                                
                                Student student = new Student(studNum, fName, midIn, lName, curse, yrLevel, crushName, faveSubj);
                                list.add(student);
                                System.out.println("\nStudent added!");
                            }else{
                            ...
                            if(database.studEnrolled(list, studNum)){
                                for(int i = 0; i < list.size(); i++) {
                                    if(list.get(i).getStudentNumber().compareTo(studNum) == 0) {
                                        ...
                                        System.out.println("Crush Name: " + s.getCrushName());
                                        System.out.println("Fave Subject: " + s.getFaveSubject());
                                        break;
                                    }
                                }
                            }else{
                        ...
                        case 4:
                            try{
                                ...
                                for(Student s: list){
                                    ...
                                    oos.writeObject(s.getCrushName());
                                    oos.writeObject(s.getFaveSubject());
                                }
                                oos.close();
